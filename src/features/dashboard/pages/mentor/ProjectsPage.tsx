  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-white mb-2">Project Details</h1>
          <p className="text-gray-400">Monitor student project progress and milestones</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <Card className="p-4 bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border-gray-800 rounded-xl">
          ...
          <p className="text-white">4 meetings</p>
        </Card>
      </div>
              ...
              <div className="flex items-start gap-4 flex-1">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className="text-white">{project.student.name}</h3>
                    <span
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-4">
                    <div className="p-3 bg-gray-900/50 rounded-lg border border-gray-800">
                      ...
                      <p className="text-white">{project.meetings} completed</p>
                    </div>
                    <div className="p-3 bg-gray-900/50 rounded-lg border border-gray-800">
                      <p className="text-xs text-gray-500 mb-1">Tasks</p>
                      <p className="text-white">{project.completedTasks} / {project.totalTasks}</p>
                    </div>
                    <div className="p-3 bg-gray-900/50 rounded-lg border border-gray-800">
                      <p className="text-xs text-gray-500 mb-1">Next Meeting</p>
                      <p className="text-white">{project.nextMeeting}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-6 text-sm text-gray-400 mt-4 pt-4 border-t border-gray-800">
          ...
          <div className="space-y-4 py-4">
            <div className="p-4 bg-gray-900/50 rounded-lg border border-gray-800">
              <p className="text-sm text-gray-300 mb-2">
                <span className="text-gray-500">Project:</span> {selectedProject?.project}
              </p>
