...
const completedWork = [
  {
    ...
    score: "95%",
    feedback:
      "Excellent work! Outstanding research methodology and clear presentation of results. Keep up the great work.",
  },
  {
    id: 2,
    ...
    score: "92%",
    feedback:
      "Well-prepared presentation with strong supporting data. Consider adding more visual aids next time.",
  },
  {
    id: 3,
    ...
    score: "88%",
    feedback:
      "Good understanding of concepts. Pay closer attention to detail in calculations for better accuracy.",
  },
  {
    id: 4,
    ...
    score: "85%",
    feedback:
      "Solid grasp of fundamentals. Review sections 5-7 for better understanding of advanced topics.",
  },
];

export function MentorCompletedPage() {
  const [selectedWork, setSelectedWork] = useState<
    (typeof completedWork)[0] | null
  >(null);
  ...
  const sendFollowUp = () => {
    if (message) {
      toast.success(
        `Follow-up message sent to ${selectedWork?.student.name}! 📨`
      );
  ...
  const exportReport = () => {
    ...
    a.href = url;
    a.download = `completed_work_report_${
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="body-font text-[#505759]">
            Review past submissions and feedback
          </p>
        </div>
        <Button
          variant="outline"
              ...
              <div className="flex items-start gap-4 flex-1">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className="heading-font text-[#212721]">
                      {work.student.name}
                    </h3>
                  ...
                  <div className="p-4 bg-[#F5F6F4] rounded-lg border border-[#e0e0e0] mb-4">
                    <p className="body-font text-sm text-[#212721]">
                      <span className="text-[#505759]">Your Feedback:</span>{" "}
                      {work.feedback}
                    </p>
                  </div>
          ...
          <div className="space-y-4 py-4">
            <div className="p-4 bg-[#F5F6F4] rounded-lg border border-[#e0e0e0]">
              <p className="body-font text-sm text-[#212721] mb-2">
                <span className="text-[#505759]">Regarding:</span>{" "}
                {selectedWork?.title}
              </p>
      ...
      <Dialog open={isDetailsDialogOpen} onOpenChange={setIsDetailsDialogOpen}>
        <DialogContent className="bg-white border border-[#e0e0e0] text-[#212721] max-w-2xl">
          ...
          <div className="space-y-4 py-4">
            <div className="p-4 bg-[#F5F6F4] rounded-lg border border-[#e0e0e0]">
              <p className="body-font text-sm text-[#212721] mb-2">
                <span className="text-[#505759]">Title:</span>{" "}
                {selectedWork?.title}
              </p>
              <p className="body-font text-sm text-[#505759]">
